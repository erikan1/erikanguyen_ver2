            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card>
                <CardBody>
                  ...
                  <p>
                    Built by connecting two Microsoft Azure Cognitive Services
                    for T-Mobile to give a sentiment analysis to speech.
                  </p>
                </CardBody>
                <CardFooter>
                  <Button
              ...
              <Card>
                <CardBody>
                  ...
                  <h5 className={classes.cardSubtitle}>
                    ...
                    Most Feasible/Viable{" "}
                  </h5>
                  <Badge color="primary">typescript</Badge>
                  <Badge color="info">xml/css</Badge>
                  <Badge color="success">node.js</Badge>
                  <p>
                    Aims to bridge the gap in online shopping for teenagers to
                    make responsible purchases with parents in the loop.
                  </p>
                </CardBody>
                <CardFooter>
                  <Button
              ...
              <Card>
                <CardBody>
                  ...
                  <h5 className={classes.cardSubtitle}>
                    ...
                    Drive Usage of Existing Feedback app - Anthem
                  </h5>
                  <Badge color="primary">javascript</Badge>
                  <Badge color="info">html5/css3</Badge>
                  <Badge color="success">node.js</Badge>
                  <p>
                    A webapp rebuild of an internal employee feedback
                    application for Blue Cross Blue Shield of Georgia.
                  </p>
                </CardBody>
                <CardFooter>
                  <Button
              ...
              <Card>
                <CardBody>
                  ...
                  <h5 className={classes.cardSubtitle}>
                    ...
                    MLH Second Place - Best in Show
                  </h5>
                  <Badge color="info">html5/css3</Badge>
                  <Badge color="danger">nlp api</Badge>
                  <p>A Google Home Assistant/Chatbot made using NCR's API.</p>
                </CardBody>
                <CardFooter>
                  <Button
                    size="small"
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card>
                <CardBody>
                  ...
                  <p>
                    A static business website made for a local DJ hosted on
                    GoDaddy.
                  </p>
                </CardBody>
                <CardFooter>
            ...
            <GridItem xs={12} sm={12} md={4}>
              <Card>
                <CardBody>
                  ...
                  <Badge color="warning">bootstrap</Badge>
                  <p>
                    A personal resume/portfolio website made using{" "}
                    <a href="https://startbootstrap.com/themes/resume/" alt="">
                      Start Bootstrap
                    </a>
                  </p>
                </CardBody>
